...
public class ParserTest {
	...
	private String cmdACL = "%% Standard IP access list 1 10 permit any %% Standard IP access list"
			+ "2 10 permit 127.0.0.1";
	private String cmdClassMap = "%% Class Map match-any class-default (id 0) Match any %% Class Map"
			+ "match-all class1 (id 1) Description: first class Match none";
