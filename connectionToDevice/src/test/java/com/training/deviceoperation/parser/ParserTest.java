...
public class ParserTest {
	...
	/* static data from the device 192.168.50.200 */
	...
	/* List of objects for parsing the data from the device */
	...
	public void testParsACL() {
		accessList = pars.parseACL(cmdACL);
	...
	public void testParsClassMap() {
		...
		System.out.println(classMapList.get(1));
